...
const faqs = [
  {
    ...
    a: "Начните с первичной консультации — она ни к чему не обязывает. Мы просто поговорим о том, что вас беспокоит, и я расскажу, чем могу помочь. Многие клиенты после первой встречи говорят: «Спасибо, я почувствовал() облегчение». Главное — сделать первый звонок или написать сообщение.",
  },
  {
    q: "Как долго длится терапия?",
    a: "Это очень индивидуально. После 1 консультации вы получаете ясность. Работа с глубинными  паттернами, отношениями или травмой может занять несколько месяцев. Я не затягиваю процесс. Наша цель — ваша самостоятельность.",
  },
  {
  ...
  },
  {
    ...
    a: "Психолог работает через разговор, самопонимания и осознание. Если у вас жизненные трудности, отношения, тревога, стресс, выгорание — вам ко мне. Если есть выраженные психические симптомы, я помогу вас правильно сориентировать и при необходимости направлю к специалисту.",
  },
  {
    q: "Что если мне неудобно говорить о чём-то личном?",
    a: "Это совершенно нормально. Никогда не давлю и не требую рассказывать больше, чем вы готовы. Темп задаёте вы. Безопасное пространство — это не просто слова, это то, что я создаю на каждой сессии.",
  },
  {
