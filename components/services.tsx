...
const services = [
  ...
  {
    number: "04",
    title: "Сопровождение в бракоразводном процессе",
    short: "Усиление правовой позиции",
    desc: "Независимый психолог-консультант для клиентов в ситуации развода, раздела имущества и споров о детях. Помогаю сохранить устойчивость, структурировать позицию и выдерживать стратегию без усиления конфликта. Работаю только с одной стороной в деле, соблюдая принцип отсутствия конфликта интересов и полную конфиденциальность.",
    tags: ["Сопровождение «под ключ»", "Подготовка к судебным заседаниям", "Точечные консультации", "Чёткие временные рамки"],
    price: "от 3 500 ₽",
    duration: "50 мин",
  ...
  },
  {
    ...
    desc: "Профессиональная психолого-педагогическая экспертиза и письменная оценка психологического состояния для судебных заседаний по вопросам семейного, гражданского, административного и уголовного права. Соблюдение конфиденциальности.",
    tags: ["Экспертное заключение", "Оценка психологического состояния", "Суд", "Официальный документ"],
    price: "По запросу",
